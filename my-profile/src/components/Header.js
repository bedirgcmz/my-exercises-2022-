...
const Header = ({ bacgroundOpc, color, borderBottom, bacgroundDark }) => {
  return (
    <div
      className={`${bacgroundOpc} ${borderBottom} ${color} header d-flex flex-column justify-content-between align-items-end px-5 w-100`}
    >
      <div className="img-container align-items-center d-flex w-100 mt-2">
        <img
          src={profileImg}
